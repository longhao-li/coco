...
> This library has a series of known problems and should not be used for productions. See [nyaio](https://github.com/longhao-li/nyaio) for a more stable and fully tested async IO library.
